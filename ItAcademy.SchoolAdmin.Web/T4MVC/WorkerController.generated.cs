...
namespace ItAcademy.SchoolAdmin.Web.Controllers
{
    public partial class WorkerController
    {
        ...
        protected WorkerController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WorkerController Actions { get { return MVC.Worker; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Worker";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Worker";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_WorkerController : ItAcademy.SchoolAdmin.Web.Controllers.WorkerController
    {
        public T4MVC_WorkerController() : base(Dummy.Instance) { }
